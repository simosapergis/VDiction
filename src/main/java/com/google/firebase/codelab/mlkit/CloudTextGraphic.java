package com.google.firebase.codelab.mlkit;// Copyright 2018 Google LLC
//
...
public class CloudTextGraphic extends Graphic {
    ...
    private final com.google.firebase.codelab.mlkit.GraphicOverlay overlay;

    CloudTextGraphic(com.google.firebase.codelab.mlkit.GraphicOverlay overlay, FirebaseVisionDocumentText.Word word) {
        super(overlay);
